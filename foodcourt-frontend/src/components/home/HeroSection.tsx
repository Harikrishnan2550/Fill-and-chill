  ...
  return (
    <div className="flex items-center gap-2">
      <div
        ...
        style={{
          background: "linear-gradient(to right, transparent, #FB923C60)",
        }}
      />
      <Lozenge />
      <div
        className="h-px flex-1"
        style={{
          background: "linear-gradient(to left, transparent, #FB923C60)",
        }}
      />
    </div>
  );
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at 68% 45%, rgba(251,146,60,0.15) 0%, transparent 62%)",
        }}
      />
      ...
      >
        ...
        />
        <div
          className="absolute inset-y-0 left-0 w-10 opacity-45"
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to top, rgba(251,146,60,0.18) 0%, transparent 100%)",
        }}
      />

      {/* Left dot strip */}
      <div
        className="absolute inset-y-0 left-0 w-6 md:w-10 opacity-50 z-[2]"
        style={{ backgroundImage: DOTS, backgroundRepeat: "repeat" }}
      />
      ...
      <div className="relative z-10 max-w-6xl mx-auto w-full px-6 sm:px-10 md:px-14 pt-24 sm:pt-28 pb-36 sm:pb-44 md:pb-48 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
        ...
        >
          ...
          >
            ...
            <span
              className="font-sans font-bold uppercase tracking-[0.45em] text-[#5e3718]"
              style={{ fontSize: "9px" }}
            >
          ...
          <motion.div
            variants={fadeUpVariants}
            className="pl-4 border-l-2 border-[#FB923C]/50 mb-7 md:mb-9"
          >
            ...
            <p
              className="font-sans font-bold uppercase tracking-[0.35em] text-[#FB923C] mt-2.5"
              style={{ fontSize: "8px" }}
            >
              — PIRAVOM , ERANAMKULAM
            </p>
          ...
          <motion.div
            variants={fadeUpVariants}
            className="grid grid-cols-3 mt-8 md:mt-11 border-t border-[#FB923C]/25"
          >
            {[
              ["8", "Chapters"],
              ["175+", "Recipes"],
              ...
              >
                ...
                <p
                  className="font-sans font-bold uppercase tracking-[0.3em] text-[#FB923C] mt-1"
                  style={{ fontSize: "7px" }}
                >
                  {label}
                </p>
        ...
        <div className="relative flex items-center justify-center h-[340px] sm:h-[480px] md:h-[620px]">
          ...
          >
            <span
              className="font-sans font-black text-white text-center leading-[1.3]"
              style={{ fontSize: "7px" }}
            >
              EST
              <br />
          ...
          >
            ...
            <span
              className="font-sans font-bold uppercase tracking-[0.3em] text-[#1a0e04]"
              style={{ fontSize: "7px" }}
            >
              SIGNATURE DISH
            </span>
          ...
          <motion.div
            style={{
              y: dishY,
              rotate: dishRotate,
              filter: "drop-shadow(0 60px 80px rgba(0,0,0,0.42))",
            }}
      ...
      >
        ...
        >
          <div
            ...
            style={{
              background:
                "linear-gradient(to right, transparent, #FB923C90, transparent)",
            }}
          />
          ...
          <div className="flex flex-col gap-3 sm:hidden">
            <div className="grid grid-cols-2 gap-3">
              <div>
                <p
                  className="font-sans font-bold uppercase tracking-[0.3em] text-[#FB923C] mb-0.5"
                  style={{ fontSize: "8px" }}
                >
                  LOCATION
                </p>
                <p className="font-black italic text-[#1a0e04] m-0 text-[14px]">
                  Piravom, Kerala
                </p>
              </div>
              <div>
                ...
                <p className="font-black italic text-[#1a0e04] m-0 text-[13px]">
                  11 AM – 11:30 PM
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <p className="font-black italic text-[#1a0e04] m-0 text-[15px]">
                  4.9
                </p>
              </div>
          ...
          <div className="hidden sm:flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2.5 shrink-0">
              ...
              <div>
                <p className="font-black italic text-[#1a0e04] leading-none m-0 text-[17px]">
                  4.9
                </p>
                <p
                  className="font-sans font-bold uppercase tracking-[0.25em] text-[#FB923C] m-0"
                  style={{ fontSize: "7px" }}
                >
                  CUSTOMER RATING
                </p>
